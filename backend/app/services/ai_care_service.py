...
class AICareService:
    ...
    async def identify_plant(
        ...
        """Use Google Vision API to identify a plant from an uploaded photo."""
        try:
            ...
            plant_entities = [e for e in entities if e.get("score", 0) > 0.5]
            if plant_entities:
    ...
    def _find_relevant_products(
        ...
        care_keywords = ["water", "fertilise", "fertilize", "soil", "pot", "repot", "care", "feed"]
